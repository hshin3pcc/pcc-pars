...
<p>Newer iOS versions block <code>javascript:</code> bookmarks. Use the <b>Shortcut</b> instead — same
code, Apple's sanctioned path:</p>
<ol>
...
<textarea rows="6" readonly id="code2">${escHtml(shortcutSrc)}</textarea>
...
`;
  return { url, html, bytes: url.length, shortcutSrc };
}
